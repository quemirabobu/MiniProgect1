...
public class MiniController {
    ...
    @GetMapping("/hahaha")
    public String attendMainPage(Model model) {
        model.addAttribute("hahajkljkha", "원하는 텍스트"); // 여기에서 값을 설정

        return "hahaha"; // Thymeleaf는 자동으로 resources/templates 디렉토리를 참조합니다.
    }
